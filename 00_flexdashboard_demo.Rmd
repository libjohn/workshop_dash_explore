...
**Linked Brusing** is possible via the `crosstalk` library package:  crostalk::SharedData$new(df)
...
- `flexdashboard` -- Mangage Dashboard Layouts (includes guagues)
- `crosstalk` -- Enables linked brushing i.e. shared data

    - Interactive **CrossTalk enabled HTML Widgets**:
